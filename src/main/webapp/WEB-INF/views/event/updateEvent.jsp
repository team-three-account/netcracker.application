        ...
        <div class="card-body">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input value="Show periodicity options" class="btn btn-primary" type="button" id="isPeriodical"
                           name="isPeriodical"
                           data-toggle="modal" data-target=".bs-example-modal-lg" onclick="changePeriodicity()"/>
                                    ...
                                    <div id="crontabs">
                                        <div>
                                            ...
                                            <div class="cron-option" style="padding-bottom:10px">
                                                ...
                                                <label for="cronDowSpecific" class="nofloat">Specific day of week
                                                    (choose one or
                                                    many)</label>
                                            ...
                                            <div class="cron-option" style="padding-bottom:10px">
                                                ...
                                                <label for="cronDomSpecific" class="nofloat">Specific day of month
                                                    (choose one
                                                    or many)</label>
                                                <div style="margin-left:50px;">
                                                    <div>
