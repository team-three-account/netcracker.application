                                        ...
                                        <div class="modal-body">
                                            <div id="crontabs">
                                                <div>
                                                    ...
                                                    <div class="cron-option" style="padding-bottom:10px">
                                                        <input type="radio" id="cronEveryDay" name="cronDay"
                                                               checked="checked">
                                                    ...
                                                    <div class="cron-option" style="padding-bottom:10px">
                                                        ...
                                                        <label for="cronDomSpecific" class="nofloat">Specific day of
                                                            month
                                                            (choose one
                                                            or many)</label>
                                                        <div style="margin-left:50px;">
                                                ...
                                                <div>
                                                    <div class="cron-option" style="padding-bottom:10px">
                                                        <input type="radio" id="cronEveryMonth" name="cronMonth"
                                                               checked="checked">
                                                    ...
                                                    <div class="cron-option" style="padding-bottom:10px">
                                                        ...
                                                        <label for="cronMonthIncrement" class="nofloat">Every
                                                            <select id="cronMonthIncrementIncrement"
                                                                    style="width:50px;">
                                                                <option value="1">1</option>
                                                                <option value="2">2</option>
                                                                <option value="3">3</option>
                                                    ...
                                                    <div class="cron-option" style="padding-bottom:10px">
                                                        ...
                                                        <label for="cronMonthSpecific" class="nofloat">Specific month
                                                            (choose
                                                            one or
                                                            many)</label>
                                                        <div style="margin-left:50px;">
                                                            <div>
                                                                <div>
                                                                    ...
                                                                    <input type="checkbox" id="cronMonth1"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="JAN"/>

                                                                    <label for="cronMonth2"
                                                                           class="nofloat">February&nbsp;&nbsp;</label>
                                                                    <input type="checkbox" id="cronMonth2"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="FEB"/>

                                                                    <label for="cronMonth3"
                                                                           class="nofloat">March</label>
                                                                    <input type="checkbox" id="cronMonth3"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="MAR"/>

                                                                    <label for="cronMonth4"
                                                                           class="nofloat">April</label>
                                                                    ...
                                                                    <label for="cronMonth8"
                                                                           class="nofloat">August</label>
                                                                    <input type="checkbox" id="cronMonth8"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="AUG"/>

                                                                    <label for="cronMonth9"
                                                                           class="nofloat">September</label>
                                                                    <input type="checkbox" id="cronMonth9"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="SEP"/>

                                                                    <label for="cronMonth10"
                                                                           class="nofloat">October</label>
                                                                    <input type="checkbox" id="cronMonth10"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="OCT"/>
                                                                </div>
                                                                <div>
                                                                    <label for="cronMonth11"
                                                                           class="nofloat">November</label>
                                                                    <input type="checkbox" id="cronMonth11"
                                                                           name="cronMonthSpecificSpecific"
                                                                           value="NOV"/>

                                                                    <label for="cronMonth12"
                                                                           class="nofloat">December</label>
